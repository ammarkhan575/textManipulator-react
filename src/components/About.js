...
export default function About() {
    ...
    const toggleMode = ()=>{
        if(myStyle.color==='white')  // (myStyle ek object hai) object ke kisi variable ko access krne ke liye . ka use krte hain
        {
            setmyStyle({
                color: 'black',
...
<button onClick={toggleMode} className="btn btn-primary m-3">Enable {mode} mode</button>
        </div>
    )
}
